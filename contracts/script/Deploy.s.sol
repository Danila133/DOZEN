...
import {AppToken} from "../src/AppToken.sol";
...
contract Deploy is Script {
    ...
    function run()
        external
        returns (Hub hub, AppToken token, BadgeNFT badges, StakePool stakePool)
    {
        ...
        hub = new Hub();
        token = new AppToken(msg.sender, AIRDROP_SUPPLY + STAKE_REWARD_BUDGET);
