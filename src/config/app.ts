...
export const APP_NAME = "DOZEN";
export const APP_SLUG = "dozen";
/** In-app token symbol shown in UI */
export const TOKEN_SYMBOL = "$D";
export const APP_TAGLINE = "Grow your grove on Base — GM, deploy, earn $D.";
...
export const BASE_APP_ID = "6a1f5559771ed4d9a6a2c585";
